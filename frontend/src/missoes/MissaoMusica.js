...
const MissaoMusica = () => {
  ...
  const [titulo] = useState("Indique uma música que faz você se sentir bem");
  ...
  return (
    <div style={{ maxWidth: 400, margin: "30px auto 0", padding: 16, fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ backgroundColor: "#58b7ff", color: "white", borderRadius: 16, padding: 20, textAlign: "center", marginBottom: 20 }}>
        <h3 style={{ fontSize: 18, marginBottom: 8 }}>Música</h3>
        <p style={{ fontWeight: "bold", marginBottom: 8 }}>🏆 100 pontos</p>
        <p style={{ fontSize: 14 }}>
          Indique uma música que faz você se sentir bem. Pode ser uma que te traz paz, alegria ou motivação. Submeta uma imagem que represente essa escolha (por exemplo, print do Spotify ou da letra).
        </p>
        <div style={{ textAlign: "left", backgroundColor: "#ffffff", color: "#0579b2", borderRadius: 12, padding: 12, marginTop: 16 }}>
          <p>📌 O que pode conter no print?</p>
          <ul style={{ paddingLeft: 20, fontSize: 14 }}>
            <li>Print do Spotify, YouTube ou outro app</li>
          </ul>
        </div>
      </div>
